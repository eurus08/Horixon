% ============================================================
%  main.tex  —  Demo presentation using the Horixon Beamer theme
...
% ---- Load theme ---------------------------------------------
%  Theme .sty files live in ./theme/ — add it to LaTeX's search path
\makeatletter\def\input@path{{theme/}}\makeatother
\usetheme[watermark=on, logo=assets/logos/nims.png]{horixon}

% ---- Load environment shortcuts + user macros ---------------
\input{theme/environment-shortcuts}
...
\title[Template]{Horixon - Beamer Presentation Theme}
\subtitle{A Custom Split-Architecture Template}
\author[Asumadu]{Asumadu Prince}
\institute[NIMS(KNUST)]{%
  Kwame Nkrumah University of Science \& Technology\\
  Faculty of Physical and Computational Sciences\\
  Department of Mathematics\\
  \textbf{National Institute of Mathematical Sciences}%
}
\date{\today}
  ...
  \columnsbegin[t]
    ...
    \colbegin{0.48\textwidth}
      \blockbegin{Toggle Watermark}
        ...
        to disable the background overlay.
      \blockend
      \blockbegin{Add Your Logo}
        Pass \texttt{logo=assets/logos/yourlogo.png}.\\
