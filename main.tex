...
\documentclass[aspectratio=169]{beamer} % add option aspectratio=169
...
\usetheme[watermark=on, logo=images/logos/nims.png]{horixon}

% ---- Load environment shortcuts + user macros ---------------
\input{environment-shortcuts}
...
\institute[NIMS(KNUST)]{Kwame Nkrumah University of Science \& Technology\\
...
\date{\today}
% \logo{\includegraphics[height=0.5cm]{images/logos/nims.png}}
